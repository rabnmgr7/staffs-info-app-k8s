...
kubectl create configmap staffs-info-app-db-config --from-env-file=./k8s-specifications/.config
kubectl create secret generic staffs-info-app-db-secret --from-env-file=./k8s-specifications/.env
